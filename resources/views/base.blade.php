...
<nav class="border-gray-200 bg-blue-300 text-white mb-10">
    <div class="w-full mx-auto">
        <div class="mx-2 flex flex-wrap items-center justify-between">
            <a href="{{route('authors.liste')}}" class="flex">
                ...
                <span class="self-center text-lg font-semibold whitespace-nowrap">Bib</span>
            </a>
            ...
            <div class="hidden md:flex justify-between items-end w-full md:w-auto md:order-1" id="mobile-menu-3">
                <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                    <li>
                        <a href="{{route('emprunts.liste')}}" class="md:bg-transparent text-lg  block pl-3 pr-4 py-2 md:p-0 rounded"
                            aria-current="page">Emprunts</a>
                    </li>
                    <li>
                        <a href="{{route('clients.liste')}}" class="md:bg-transparent text-lg  block pl-3 pr-4 py-2 md:p-0 rounded"
                            >Clients</a>
                    </li>
                    <li>
                        <a href="{{route('livres.liste')}}" class="md:bg-transparent text-lg  block pl-3 pr-4 py-2 md:p-0 rounded"
                            >Livres</a>
                    </li>
